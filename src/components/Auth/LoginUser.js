        ...
        <div className="flex flex-wrap">
            ...
            <div className="max-w-md mx-auto">
              <div className="mb-6 lg:mb-20 w-full px-3 flex items-center justify-between">
                <a className="text-3xl font-bold leading-none" href="#_">
                  ...
                  <a className="py-2 px-6 text-xs rounded bg-blue-100 hover:bg-blue-200 text-blue-600 font-bold transition duration-200" href="#_">Sign In</a></div>
              <div>
                ...
                <form>
                  ...
                  <div className="px-3 text-center">
                    ...
                    <span className="text-gray-400 text-xs">
                      ...
                      <a className="text-blue-600 hover:underline" href="#_">Sign In</a>
                    </span>
          ...
          <div className="hidden lg:block relative w-full lg:w-1/2">
            ...
            <div className="absolute bottom-0 inset-x-0 mx-auto mb-12 max-w-xl text-center" style={{zIndex: 10}}>
              ...
              <a className="inline-block py-2 px-6 rounded-t-xl leading-loose rounded-l-xl bg-blue-600 hover:bg-blue-700 text-gray-50 font-bold transition duration-200" href="#_">Get Started</a>
            </div>
          </div>
