                    ...
                    <table className="min-w-full bg-white shadow border py-4">
                        <thead>
                            <tr className="w-full h-16 border-gray-300 dark:border-gray-200 border-b py-8">
                                ...
                                <th className="text-gray-600 dark:text-gray-400 font-normal pr-6 text-left text-sm tracking-normal leading-4">Test Name</th>
                        ...
                        <tbody>
                            <tr className="h-24 border-gray-300 dark:border-gray-200 border-b">
                                ...
                                <td className="text-sm pr-6 whitespace-no-wrap text-gray-800 dark:text-gray-100 tracking-normal leading-4">Lorem ipsum dolor sit amet.</td>
