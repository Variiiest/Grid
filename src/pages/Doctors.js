...
<div className="p-4">
          ...
          <input type="text" name="search" placeholder="Search Disease" className="w-full h-12 px-6 py-2 font-medium text-gray-800 focus:outline-none bg-white" value={this.state.value} onChange={this.handleChange} /> <span className="top-0 right-0 block">
